...
ALTER TABLE weather_triggers ADD COLUMN IF NOT EXISTS buy_prev_no BOOLEAN NOT NULL DEFAULT TRUE;
ALTER TABLE weather_triggers ADD COLUMN IF NOT EXISTS is_boundary BOOLEAN NOT NULL DEFAULT FALSE;
